...
- [x] Verify pointer `i`
- [ ] Verify found / not found scenarios
...
- [ ] Step through `indexOf`
- [ ] Step through `reverse`
- [ ] Reset after partial execution
- [ ] Run to completion
...
- [ ] Add visual legend for colors and markers
  - Owner: Frontend
  - Priority: Medium
...
- [ ] Add welcome lesson / intro screen
  - Owner: Frontend
  - Priority: Low
...
- [ ] Add copy / reset lesson code button
  - Owner: Frontend
  - Priority: Low
...
- [ ] Add authoring guide for new lessons
  - Owner: Lead
  - Priority: Medium
  - Notes:
...
- [ ] Next / Run / Pause / Reset work
- [ ] Array visualization updates correctly
- [ ] Pointer markers move correctly
- [ ] Variables panel updates correctly
- [ ] Operation log is understandable
- [ ] At least 5 lessons are available
- [ ] Basic tests pass
